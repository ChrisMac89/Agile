...
<body>
	...
	<div class="container">
		...
		<h2 style="color: #5e9ca0; text-align: center;">
			<span style="color: #ffffff;">Exam Work Flow Management System</span>
		</h2>
		<br>
		...
		<form action="profile/controller/Sign_in_controller.jsp" method="POST">
			...
			<br> <br> <span style="color: #ffffff;">Password:</span>&nbsp;
			&nbsp; <input type="password" name="password" value="" size="50" />

			<br> <br>
			Please Select your position:&nbsp; &nbsp; 
			<select name="position">
			  <option name="position" value="TeachingStaff">Teaching Staff</option>
			  <option name="position" value="InternalModerator">Internal Moderator</option>
